...
<head>
    ...
    <link rel="stylesheet" href="../../assets/styles/pages/info/politicadedespachos.css">
</head>
<body>
    <?php include '../../components/header.php' ?>
    <div class="container mb-4 container-main">
        <h1 class="text-center mt-5">Despachos y Entregas</h1>

        <div class="row justify-content-center mt-5">
            <div class="col-12 col-xl-10">
                <h3 class="mb-3">Políticas de Despacho:</h3>
                ...
                <p>Mercadito.</p>
                <img src="../../assets/images/banner-politica.jpg" class="img_end"/>
            </div>
        </div>
     </div>
