<?php
require '../models/DetalleVentaEnvioFinal.php';

class DetalleVentaEnvioTotal
{
    ...
    public function selectFinalVenta($venta)
    {
        $lista = array();
        ...
        while ($rs = mysqli_fetch_array($st)) {
            $lista[] = new VentaEnvioFinal($rs['id'], $rs['imagen'], $rs['titulo'], $rs['precio'], $rs['cantidad_prod'], $rs['codigo'], $rs['cantidad'], $rs['total'], $rs['nombre'], $rs['direccion'], $rs['comuna'], $rs['telefono'], $rs['tipo']);;
        }
